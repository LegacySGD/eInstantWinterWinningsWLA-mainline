...
public class DownhillCashWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(DownhillCashWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/DownhillCashWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/DownhillCashWLAIW/InitOutcome.xml").getDocumentElement();
